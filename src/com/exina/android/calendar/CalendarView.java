...
import com.example.bunkmonitor.R;
...
public class CalendarView extends ImageView {
    ...
    int screenWidthInPix,screenheightInPix;
...
//		CELL_TEXT_SIZE = res.getDimension(R.dimen.cell_text_size);
        ...
        CELL_MARGIN_TOP = mWeekTitle.getMinimumHeight();
    ...
    public void drawNameOfMonthYear(Canvas canvas){
        Paint p = new Paint();
        p.setColor(Color.BLACK);
        canvas.drawText(""+DateUtils.getMonthString(getMonth(), DateUtils.LENGTH_LONG) + " "+getYear(),(int)(screenheightInPix*0.33),7*CELL_WIDTH,p);
    ...
    public void drawGridLines(Canvas canvas){
        ...
        p.setColor(Color.BLACK);
        for(int i=1;i<=6;i++){
            canvas.drawLine(i*CELL_WIDTH,0,i*CELL_WIDTH,mWeekTitle.getMinimumHeight()+6*CELL_WIDTH,p);
        }
